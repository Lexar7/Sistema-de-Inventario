...
namespace Sistema_de_Inventario
{
    public partial class Ventas : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.Columns.Add("Id_dVenta", "Id_dVenta");
            dataGridView1.Columns.Add("IdProducto", "IdProducto");
            dataGridView1.Columns.Add("Precio_Unitario", "Precio_Unitario");
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            {
                dataGridView1.Columns.Clear();
                dataGridView1.DataSource = clsVenta.BuscarNombre(textBox15.Text);
            }
            else if(radioButton4.Checked==true)
            {
                dataGridView1.Columns.Clear();
                dataGridView1.DataSource = clsVenta.BuscarRango(textBox16.Text,textBox17.Text);
            }
        }
